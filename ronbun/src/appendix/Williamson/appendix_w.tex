...
数値モデルの作成に使用した
地球流体電脳倶楽部の階層的地球スペクトルモデル集(SPMODEL; \citealp{spmodel2006,spmodel2013} )
のver. 1 とver. 2 の並列化効率の比較を行う．
この計算をするにあたり，\cite{TakehiroWilliamson}, \cite{OdakaWilliamson} を参考にした．作成したソースコードや計算結果などはweb ページ\footnote{\url{https://www.gfd-dennou.org/library/numexp/spshallow-zd_forced_storm/test/williamson/williamson.htm}} を参照されたい．
%%%% case1 %%%%
