...
この計算をするにあたり，\cite{TakehiroWilliamson}, \cite{OdakaWilliamson} を参考にした．作成したソースコードや計算結果などはweb ページ\footnote{\url{http://www.ep.sci.hokudai.ac.jp/~rsuzuki/research/williamson/williamson.html}} を参照されたい．
%%%% case1 %%%%
