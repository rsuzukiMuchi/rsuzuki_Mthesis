...
$\tau_{\rm{APE}}$は局所的な流体層の厚さの変化を
$\langle h_{\rm{eq}} \rangle $ に向かって緩和する．
...
行ったケースは$T341 : R_{\rm{storm}} = 8.72 \times 10^5 ~(0.7^\circ), 
T170 : R_{\rm{storm}} = 2.62 \times 10^6 ~(2.1^\circ)$ であり，
それぞれのケースで$R_{\rm{storm}}$の中に最低でも3個の格子点を含んでいる．
