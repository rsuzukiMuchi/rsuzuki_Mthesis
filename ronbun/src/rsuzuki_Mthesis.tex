...
赤道域の東風ジェットと緯度約$\pm 20^\circ \sim 30^\circ$ で西風ジェットが形成した．
赤道でジェットが形成する全てのケースでジェットの向きは西向きである．
%
図\ref{fig:casae1_rms_comp} を見てみると，
\cite{Showman2007} の結果と比較して，我々の計算では
赤道域の東風ジェットの風速約10倍大きい．
これは，\cite{Showman2007} では考慮されていない極域あるいは
反対半球の存在がジェットの強度に影響を与える可能性を示唆しているのかもしれない．
%
以上の結果から雷雲による強制により，
土星，天王星，海王星の極域で見られるような
単一の低気圧性渦は形成したが，木星で見られる
複数の低気圧性渦の規則的は配置はみられなかった．
%
東西風速分布はジェットが形成する全てのケースで
赤道域で東風，また中緯度で西風ジェットといった帯状構造が形成した．
...
幾度となく，ご指導頂きました．
心より，感謝申し上げます．
数値モデルにはSPMODEL (\cite{spmodel2006},\cite{spmodel2013})を使用させて頂きました.
