...
\end{align}
%
また，上層の厚さ$h$を上層の厚さの平均場$h_{eq}$とそこからのずれ$h'$を用いて，\\
$h=h'(\lambda, \phi, t) + h_{eq}$と書くと
\begin{align}
\DP{\zeta}{t} &= - \frac{1}{a (1-\mu^2)}
\DP{}{\lambda} [(\zeta + f)U] 
...
\newpage
\subsection*{・数値粘性項}
式(\ref{ape:B16}), (\ref{ape:B17}), (\ref{ape:B18})の数値粘性項 : $D_\zeta, D_D, D_h$はそれぞれ
\begin{align}
